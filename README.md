...
## OVID
    https://openathens.ovid.com/secure-ssl/home.oa?idpselect={IDP地址}/idp/shibboleth&entityID=https://{IDP地址}/idp/shibboleth&T=JS&CSC=y&PAGE=dblist&NEW
 ## 重庆维普
   http://qikan.cqvip.com/qikan/carsi/Authorize?entityid={IDP地址}/idp/shibboleth
